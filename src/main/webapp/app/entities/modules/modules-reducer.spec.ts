...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './modules.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODULES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MODULES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MODULES actions', async () => {
      const arg = { id: 11536 };
    ...
    it('dispatches UPDATE_MODULES actions', async () => {
      const arg = { id: 11536 };
    ...
    it('dispatches PARTIAL_UPDATE_MODULES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MODULES actions', async () => {
      const arg = 42666;
