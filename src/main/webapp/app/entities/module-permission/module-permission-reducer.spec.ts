...
import reducer, {
  ...
  reset,
  updateEntity,
} from './module-permission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODULEPERMISSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MODULEPERMISSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MODULEPERMISSION actions', async () => {
      const arg = { id: 1831 };
    ...
    it('dispatches UPDATE_MODULEPERMISSION actions', async () => {
      const arg = { id: 1831 };
    ...
    it('dispatches PARTIAL_UPDATE_MODULEPERMISSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MODULEPERMISSION actions', async () => {
      const arg = 42666;
