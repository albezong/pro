...
export const ModulePermissionUpdate = () => {
  ...
  const handleClose = () => {
    navigate(`/module-permission${location.search}`);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="proyecto3UJhipsterApp.modulePermission.home.createOrEditLabel" data-cy="ModulePermissionCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('proyecto3UJhipsterApp.modulePermission.canHistory')}
                id="module-permission-canHistory"
                name="canHistory"
                data-cy="canHistory"
                check
                type="checkbox"
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/module-permission" replace color="info">
