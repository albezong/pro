...
import { getEntities } from './module-permission.reducer';
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="proyecto3UJhipsterApp.modulePermission.module">Module</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {modulePermission.module ? (
                      <Link to={`/modules/${modulePermission.module.id}`}>{modulePermission.module.nombre}</Link>
                    ) : (
                      ''
                    )}
                  </td>
