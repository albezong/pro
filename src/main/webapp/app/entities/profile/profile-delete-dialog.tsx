...
export const ProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="proyecto3UJhipsterApp.profile.delete.question">
        <Translate contentKey="proyecto3UJhipsterApp.profile.delete.question" interpolate={{ id: profileEntity.id }}>
