  ...
  return (
    <div>
      <h2 id="profile-heading" data-cy="ProfileHeading">
        <Translate contentKey="proyecto3UJhipsterApp.profile.home.title">Profiles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="proyecto3UJhipsterApp.profile.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/profile/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="proyecto3UJhipsterApp.profile.home.createLabel">Create new Profile</Translate>
          </Link>
        </div>
      </h2>
        ...
        {profileList && profileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="proyecto3UJhipsterApp.profile.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('isSuperAdmin')}>
                  <Translate contentKey="proyecto3UJhipsterApp.profile.isSuperAdmin">Is Super Admin</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('isSuperAdmin')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {profileList.map((profile, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{profile.isSuperAdmin ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="proyecto3UJhipsterApp.profile.home.notFound">No Profiles found</Translate>
            </div>
          )
        )}
      </div>
